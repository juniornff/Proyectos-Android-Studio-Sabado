...
public class EstudianteEditarActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void onClick (View view){
        ...
        if (seleccionado){
            ...
            if (helper.updateEstudiante(actualizado) > 0){
                Toast.makeText(this,"Estudiante actualizado exitosamente", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(EstudianteEditarActivity.this, MainActivity.class);
                startActivity(intent);
            } else {
                Log.i("EditarActivity", "Error al editar Estudiante");
            }
            ...
            if (helper.addEstudiante(nuevo) == -1) {
                Log.i("EditarActivity", "Error al agregar Estudiante");
            } else {
                Toast.makeText(this,"Estudiante creado exitosamente", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(EstudianteEditarActivity.this, MainActivity.class);
                startActivity(intent);
            }
        }
