package com.example.registrodeestudiantesmvp.model.services;
...
import com.example.registrodeestudiantesmvp.model.db.EstudiantesDBHelper;
...
public class EstudianteServices {
    ...
    public EstudianteServices(Context context){
    ...
    public List<Estudiante> getAllEstudianteList(){
        ...
        EstudiantesDBHelper dbHelper = new EstudiantesDBHelper(context);
